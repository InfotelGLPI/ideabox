...
xgettext *.php */*.php --copyright-holder='Ideabox Development Team' --package-name='GLPI - Ideabox plugin' --package-version='2.0.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
